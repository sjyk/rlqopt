    ...
    extends TestCase
{
    ...
    public void testJoinFlattening() throws OperatorException
    {
        ...
        assertEquals(f.apply(j3).toString(), "KWayJoinOperator([TableAccessOperator([R302.a, R302.f, R302.g]), TableAccessOperator([R201.d, R201.e]), TableAccessOperator([R294.a, R294.b, R294.c]), TableAccessOperator([R297.b, R297.c, R297.d])])");
    ...
    public void testCascadedSelect() throws OperatorException
    {
        ...
        Expression e = new Expression(Expression.AND, 
                                        new Expression( Expression.EQUALS, 
                                                        r.get("a").getExpression(), 
                                                        new Expression("1")
                                                       ),

                                        new Expression( Expression.EQUALS, 
                                                        r.get("b").getExpression(), 
                                                        new Expression("2")
                                                       )
                                      );
        ...
        assertEquals(f.apply(sel).toString(), "SelectOperator([SelectOperator([TableAccessOperator([R294.a, R294.b, R294.c])])])");
    ...
    public void testEagerSelectProject1() throws OperatorException
    {
        ...
        assertEquals(o2.apply(o1.apply(sel)).toString(), "JoinOperator([TableAccessOperator([R302.a, R302.f, R302.g]), JoinOperator([TableAccessOperator([R201.d, R201.e]), JoinOperator([SelectOperator([TableAccessOperator([R294.a, R294.b, R294.c])]), SelectOperator([TableAccessOperator([R297.b, R297.c, R297.d])])])])])");
    }
    ...
    public void testEagerSelectProject2() throws OperatorException
    {
        ...
        assertEquals(o3.apply(o2.apply(o1.apply(gb))).toString(), "GroupByOperator([JoinOperator([ProjectOperator([TableAccessOperator([R302.a, R302.f, R302.g])]), JoinOperator([TableAccessOperator([R201.d, R201.e]), JoinOperator([SelectOperator([TableAccessOperator([R294.a, R294.b, R294.c])]), SelectOperator([TableAccessOperator([R297.b, R297.c, R297.d])])])])])])");
