    ...
    extends TestCase
{
    ...
    public void testRelAlgComposition() throws OperatorException
    {
        ...
        assertEquals(sel.toString(), "ProjectOperator([TableAccessOperator([R294.a, R294.b, R294.c])])"); 

        OperatorParameters join_params = new OperatorParameters(new Expression(Expression.EQUALS, s.get("a").getExpression(), s.get("b").getExpression()).getExpressionList());
        JoinOperator j = new JoinOperator(join_params,sel,r); 
        //System.out.println(j);
        assertEquals(j.toString(), "JoinOperator([ProjectOperator([TableAccessOperator([R294.a, R294.b, R294.c])]), TableAccessOperator([R294.a, R294.b, R294.c])])"); 
    ...
    public void testOperatorAttribute() throws OperatorException
    {
        ...
        //fix
        //assertEquals(, "JoinOperator([ProjectOperator([TableAccessOperator([R294.a, R294.b, R294.c])]), TableAccessOperator([R294.a, R294.b, R294.c])])");  
    }
}
