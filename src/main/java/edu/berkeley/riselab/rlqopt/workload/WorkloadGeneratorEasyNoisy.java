...
import edu.berkeley.riselab.rlqopt.opt.NoisyTableStatisticsModel;
...
public class WorkloadGeneratorEasyNoisy extends WorkloadGenerator {

  Database db;
  Random rand;
  TableStatisticsModel ts;
  NoisyTableStatisticsModel nts;

  public WorkloadGeneratorEasyNoisy(int numRelations, int numAttributes, int oom, double scaling) {
    ...
    nts = new NoisyTableStatisticsModel(scaling, ts);
  }
