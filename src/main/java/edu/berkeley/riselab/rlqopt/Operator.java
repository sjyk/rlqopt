...
abstract public class Operator
{
	 ...
	 **/
	public Operator(OperatorParameters params, 
					Operator...source) throws OperatorException{

		if (!isValid(params, source))
	...
	public LinkedList<Attribute> getVisibleAttributes(){
		...
		for (Operator o: source)
			visibleAttrs.addAll(o.getVisibleAttributes());
	...
	public abstract boolean isValid(OperatorParameters params, 
									Operator...source);
	...
	public String toString(){
		...
		if (source.size() == 0)
			return className + "("+ params.expression +")";
		else {
