...
public class LeftDeepJoinReorder {
  ...
  public LeftDeepJoinReorder(boolean resetPerSession){

  	this.resetPerSession = resetPerSession;
  ...
  private Operator greatest(HashMap<HashSet<Operator>, Operator> map, 
  							CostModel c, HashSet<Operator> key,  Operator newOp)
  {
  ...
  public Operator apply(Operator in, CostModel c) throws OperatorException{
  ...
  private HashMap<HashSet<Operator>, Operator> dynamicProgram( HashMap<HashSet<Operator>, Operator> costMap, CostModel c, Operator in) throws OperatorException{
