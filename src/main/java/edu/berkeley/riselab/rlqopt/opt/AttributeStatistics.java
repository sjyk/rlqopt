...
public class AttributeStatistics {
  ...
  public double estimateReductionFactor(Expression e) throws CannotEstimateException {
    ...
    if (e.op.equals(Expression.EQUALS)) {
      ...
      if (e.op.equals(Expression.GREATER_THAN) || e.op.equals(Expression.GREATER_THAN_EQUALS)) {
      ...
      if (e.op.equals(Expression.LESS_THAN) || e.op.equals(Expression.LESS_THAN_EQUALS)) {
    ...
    if (e.op.equals(Expression.NOT)) {
      ...
      double total = 0.0;
      for (Expression c : e.children) total += estimateReductionFactor(c);
      return clip10(total);
