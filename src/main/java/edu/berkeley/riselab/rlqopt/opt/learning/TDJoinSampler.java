...
public class TDJoinSampler implements PlanningModule {
  ...
  private Expression findJoinExpression(ExpressionList e, Operator i, Operator j){
    ...
    for (Expression child: e){
      ...
      if (isSubList(leftAttributes, lefte) && isSubList(rightAttributes, righte))
        return child;
  ...
  public HashSet<Operator> TDMerge(HashSet<Operator> relations, CostModel c, Operator in) throws OperatorException {
